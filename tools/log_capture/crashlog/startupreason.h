...
#else
static inline int read_resettype(char __attribute__((unused)) *resettype) {return -1;}
static inline int read_resetsource(char __attribute__((unused)) *resetsource) {return -1;}
static inline int read_wakesource(char __attribute__((unused)) *wakesource) {return -1;}
static inline int read_shutdownsource(char __attribute__((unused)) *shutdownsource) {return -1;}
#endif
