...
PRODUCT_COPY_FILES += \
	...
	vendor/rockchip/common/vpu/lib/arm64/rk3399/libjpeghwdec.so:system/lib64/libjpeghwdec.so \
        ...
        vendor/rockchip/common/vpu/lib/arm64/rk3399/libvpu_secure.so:system/lib64/libvpu_secure.so \
        vendor/rockchip/common/vpu/lib/arm/rk3399/libvpu_secure.so:system/lib/libvpu_secure.so 
endif
...
ifneq ($(filter rk312x rk3126c rk3128 rk3188, $(TARGET_BOARD_PLATFORM)), )
    ...
    ifneq ($(filter rk3228 rk3366 rk3399, $(TARGET_BOARD_PLATFORM)), )
        PRODUCT_COPY_FILES += \
        ...
        ifneq ($(filter rk3328, $(TARGET_BOARD_PLATFORM)), )
			...
			ifneq ($(filter rk3288, $(TARGET_BOARD_PLATFORM)), )
				PRODUCT_COPY_FILES += \
					vendor/rockchip/common/vpu/etc/media_codecs_performance_rk3288.xml:system/etc/media_codecs_performance.xml	
			else
				PRODUCT_COPY_FILES += \
